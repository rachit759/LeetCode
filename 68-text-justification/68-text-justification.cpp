...
public:
    ...
    */
    void greedypick(vector<string>& words, int maxWidth, int& index, vector<string>& lineWords) {
    ...
    */
    void leftJustify(vector<string>& words, int maxWidth, string& line) {
    ...
    return justified result in "line"
    */
    void fullJustify(vector<string>& words, int maxWidth, string& line) {
    ...
    vector<string> fullJustify(vector<string>& words, int maxWidth) {
        ...
        while (index < words.size()) { // loop through all words
            greedypick(words, maxWidth, index, lineWords);
            if (index < words.size()) fullJustify(lineWords, maxWidth, line);
            else leftJustify(lineWords, maxWidth, line);
            output.push_back(line);
            line.clear();     // clear cache and start processing a new line
            lineWords.clear();
        }
        return output;
    }
